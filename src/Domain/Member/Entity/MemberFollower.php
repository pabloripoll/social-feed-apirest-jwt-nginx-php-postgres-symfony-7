...
class MemberFollower
{
    ...
    #[ORM\ManyToOne(targetEntity: User::class)]
    #[ORM\JoinColumn(name: "follower_user_id", referencedColumnName: "id", nullable: false, onDelete: "CASCADE")]
    private User $follower_user_id;

    public function getFollowerUserId(): User
    {
        return $this->follower_user_id;
    }

    public function setFollowerUserId(User $follower_user_id): self
    {
