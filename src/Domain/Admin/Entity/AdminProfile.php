...
use App\Domain\Admin\Repository\AdminProfileRepository;

#[ORM\Entity(repositoryClass: AdminProfileRepository::class)]
#[ORM\HasLifecycleCallbacks]
#[ORM\Table(name: "admins_profile")]
#[ORM\UniqueConstraint(name: "uniq_admins_profile_nickname", columns: ["nickname"])]
class AdminProfile
{
    #[ORM\Id]
